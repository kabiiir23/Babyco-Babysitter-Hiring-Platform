        ...
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="requests.php">BABYCO</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li role="presentation" class="nav-item nav-link js-scroll-trigger"><a href="requests.php" class="nav-link js-scroll-trigger">Requests</a></li>
            ...
            <div class="row">
                <div class="col-xl-8 offset-xl-2">
                    ...
                    <?php
                                ...
                                ?>   
                        <div class="table-responsive border rounded" style="width:800px;margin: 25px -30px;background-color: #f1f7fc;color: rgb(0,0,0);">
                            <table class="table">
                                ...
                                <?php while ($row = $result->fetch_assoc()): ?> 
                                    <tr class="table-active">
                                        ...
                                        <a class="btn btn-primary text-center border rounded d-flex" role="button" style="background-color: rgb(220,75,66);" href="delete.php?email=<?php echo $row['Email']; ?>" >Delete</a>
                                        </td>
