...
$result = $link->query(
    "SELECT * FROM `Jobs` WHERE bbs_id='{$_SESSION['id']}'"
);
...
$result = $link->query(
    "SELECT * FROM `Client` WHERE cli_id='{$cli_id}'"
);
                ...
                <div class="col-xl-8 offset-xl-2">
                        <div class="row">
                            <div class="col-lg-8 col-xl-9 offset-xl-0 mx-auto">
                                <h1 class="brand-heading" style="margin: 25px 0px;font-size: 35px;">Your Current Jobs</h1>
                            </div>
                        </div>
                    <?php
                                if ($result->num_rows > 0) {
                        ...
                        <div class="table-responsive border rounded" style="margin: 25px 0px;background-color: #f1f7fc;color: rgb(0,0,0);">
                            <table class="table">
                                ...
                                <thead>
                                    <tr>
                                        <th class="table-dark" style="background-color: rgba(0,0,0,0);color: #1e2833;">Time</th>
                                        <th>CLient</th>
                                        <th>Email</th>
                                        <th>Address</th>
                                        <th>Phone</th>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-xl-9 offset-xl-0 mx-auto">
                                <h1 class="brand-heading" style="margin: 25px 0px;font-size: 45px;">SORRY, THERE IS NO JOB FOR YOU YET</h1>
                            </div>
                        </div>
                        <?php
                        }
